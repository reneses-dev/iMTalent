...
<div class="cv-container p-2">
    ...
    <form class="bg-white py-3 px-4 shadow rounded justify-content-center" action="{{ route('profile.update') }}" method="post">
        @method('patch') @csrf
        <!-- Información básica -->
        ...
        <div class="row align-items-center py-4">
            <div>
                <button class="btn btn-primary btn-lg btn-block form-control text-white mt-5">
                    Actualizar
                </button>
